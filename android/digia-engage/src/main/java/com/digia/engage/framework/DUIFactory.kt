...
import com.digia.engage.framework.component.DUIComponent
import com.digia.engage.framework.logging.Logger
import com.digia.engage.framework.page.ConfigProvider
import com.digia.engage.framework.page.DUIConfigProvider
import com.digia.engage.framework.page.DUIPage
import com.digia.engage.framework.utils.asSafe
...
internal class DUIFactory private constructor() {
    ...
    fun CreateNavHost(
        ...
        androidx.compose.runtime.LaunchedEffect(Unit) {
            val intent =
                    com.digia.engage.framework.navigation.DigiaUINavigationActivity.createIntent(
                            context = context,
