...
import com.digia.engage.framework.models.LocalAsset
import com.digia.engage.network.NetworkClient
import com.digia.engage.utils.DigiaInspector
import com.digia.engage.utils.DigiaUIHost
...
internal class DigiaUIManager private constructor() {
    ...
    val host: DigiaUIHost?
        get() = safeInstance?.initConfig?.developerConfig?.host
    ...
    var bottomSheetManager: com.digia.engage.framework.bottomsheet.BottomSheetManager? = null

    /** The dialog manager for displaying dialogs */
    var dialogManager: com.digia.engage.framework.dialog.DialogManager? = null
