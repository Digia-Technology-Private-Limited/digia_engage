...
class VWAppBar(
    ...
    private fun _buildLeading(
        ...
        actionExecutor: com.digia.engage.framework.actions.ActionExecutor,
        stateContext: com.digia.engage.framework.state.StateContext?,
        resources: com.digia.engage.framework.UIResources
    ): (@Composable () -> Unit)? {
