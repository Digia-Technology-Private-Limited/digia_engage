package com.digia.engage.framework.utils
...
import com.digia.engage.network.ApiHandler
import com.digia.engage.network.ApiResponse
...
suspend fun executeApiAction(
        ...
        progressCallback: ((com.digia.engage.network.UploadProgress) -> Unit)? = null
): ApiResponse<Any> {
