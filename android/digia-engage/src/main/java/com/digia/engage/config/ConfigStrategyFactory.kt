...
import com.digia.engage.config.source.AssetConfigSource
import com.digia.engage.config.source.CachedConfigSource
import com.digia.engage.config.source.ConfigSource
import com.digia.engage.config.source.DelegatedConfigSource
//import com.digia.engage.config.source.FallbackConfigSource
import com.digia.engage.config.source.NetworkConfigSource
import com.digia.engage.config.source.NetworkFileConfigSource
import com.digia.engage.framework.logging.Logger
import com.digia.engage.init.CacheFirstStrategy
import com.digia.engage.init.Flavor
import com.digia.engage.init.LocalFirstStrategy
import com.digia.engage.init.NetworkFirstStrategy
...
object ConfigStrategyFactory {
    ...
    private fun createReleaseFlavorConfigSource(
        provider: ConfigFetcher,
        priority: com.digia.engage.init.DSLInitStrategy,
