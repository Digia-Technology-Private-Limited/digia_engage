...
class ActionProcessorFactory {
    fun getProcessor(action: Action,registry: MethodBindingRegistry): ActionProcessor<*> {
        return when (action.actionType) {
            ...
            ActionType.SHOW_COACHMARK -> com.digia.digiaui.framework.actions.showCoachmark.ShowCoachmarkProcessor()
            ActionType.DISMISS_COACHMARK -> com.digia.digiaui.framework.actions.showCoachmark.DismissCoachmarkProcessor()
            ActionType.SHOW_TOOLTIP -> com.digia.digiaui.framework.actions.showTooltip.ShowTooltipProcessor()
            ActionType.DISMISS_TOOLTIP -> com.digia.digiaui.framework.actions.showTooltip.DismissTooltipProcessor()
            ActionType.SHOW_FLOATER -> com.digia.digiaui.framework.actions.showFloater.ShowFloaterProcessor()
            ActionType.DISMISS_FLOATER -> com.digia.digiaui.framework.actions.showFloater.DismissFloaterProcessor()
            ActionType.SHOW_PIP -> com.digia.digiaui.framework.actions.showPip.ShowPipProcessor()
            ActionType.DISMISS_PIP -> com.digia.digiaui.framework.actions.showPip.DismissPipProcessor()
