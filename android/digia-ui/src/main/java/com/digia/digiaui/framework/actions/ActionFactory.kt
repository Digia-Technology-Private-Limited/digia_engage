        ...
        fun fromJson(json: JsonLike): Action? {
            ...
            val action: Action? = when (actionType) {
               ...
               ActionType.CALL_REST_API -> CallRestApiAction.fromJson(actionData)
                ...
                ActionType.SHOW_COACHMARK -> com.digia.digiaui.framework.actions.showCoachmark.ShowCoachmarkAction.fromJson(actionData)
                ActionType.DISMISS_COACHMARK -> com.digia.digiaui.framework.actions.showCoachmark.DismissCoachmarkAction.fromJson(actionData)
                ActionType.SHOW_TOOLTIP -> com.digia.digiaui.framework.actions.showTooltip.ShowTooltipAction.fromJson(actionData)
                ActionType.DISMISS_TOOLTIP -> com.digia.digiaui.framework.actions.showTooltip.DismissTooltipAction.fromJson(actionData)
                ActionType.SHOW_FLOATER -> com.digia.digiaui.framework.actions.showFloater.ShowFloaterAction.fromJson(actionData)
                ActionType.DISMISS_FLOATER -> com.digia.digiaui.framework.actions.showFloater.DismissFloaterAction.fromJson(actionData)
                ActionType.SHOW_PIP -> com.digia.digiaui.framework.actions.showPip.ShowPipAction.fromJson(actionData)
                ActionType.DISMISS_PIP -> com.digia.digiaui.framework.actions.showPip.DismissPipAction.fromJson(actionData)
